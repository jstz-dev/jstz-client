...
describe('resource subkeys', () => {
  test('list', async () => {
    const responsePromise = client.accounts.kv.subkeys.list('address');
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.accounts.kv.subkeys.list('address', { path: '/_stainless_unknown_path' }),
